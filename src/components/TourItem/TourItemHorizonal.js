                    ...
                    <div className=" md:w-7/12 p-3">
                        ...
                        <div className="md:flex">
                            ...
                            <div className="md:w-1/2 flex items-center mt-1 md:mt-2">
                                ...
                                <span className="ml-1 text-blue-700 font-bold lg:text-base md:text-sm truncate">TP. Hồ Chí Minh </span>
                            </div>
                        </div>
                        <div className="md:flex">
                            <div className="md:w-1/2 flex items-center mt-1 md:mt-2">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="relative w-5/6 md:w-2/3 md:mx-auto  mt-2">
                                <div className="relative overflow-hidden w-3/4 mx-auto">
                                    ...
                                    >
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">10/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">11/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">12/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">13/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">14/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">10/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">11/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">12/11</button>
                                        <button className="bg-white text-red-500 hover:text-white px-2 m-1  lg:text-base md:text-sm rounded border border-red-500 hover:bg-red-500">13/11</button>
                                ...
                                <button onClick={handlePrevClick} className="absolute top-1/2 left-0 transform -translate-y-1/2 text-2xl bg-gray-100 hover:bg-gray-300 focus:bg-gray-300 rounded-full text-black w-10 h-10 flex items-center justify-center font-bold shadow-md transition-all duration-200 ease-in-out">
                                        ‹
                                    </button>
                                    <button onClick={handleNextClick} className="absolute top-1/2 right-0 transform -translate-y-1/2 text-2xl bg-gray-100 hover:bg-gray-300 focus:bg-gray-300 rounded-full text-black w-10 h-10 flex items-center justify-center font-bold shadow-md transition-all duration-200 ease-in-out">
                                        ›
                                    </button>
                            </div>
                        </div>
