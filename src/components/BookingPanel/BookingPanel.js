    ...
    <div className="w-full lg:max-w-[350px] mx-auto md:max-w-none flex flex-col sticky right-0 top-20 self-start ">
      <div className="animate-slideInUp shadow-xl hover:shadow-2xl transition-shadow duration-300 p-6 rounded-lg">
        <div className="mb-4">
          ...
          {date?.promo > 0 && (
            <p className="sm:text-3xl text-xl text-gray-400 line-through">
              {formatPrice(tour.price)}đ <span className="text-sm"></span>
            </p>
          )}
          ...
          <p className="sm:text-3xl text-xl  font-bold text-red-600">
            {tour.price
              ? priceAfterPromo
                ? formatPrice(priceAfterPromo)
                : formatPrice(tour.price)
              : ""}{" "}
            đ <span className="text-sm">/ Khách</span>
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center sm:text-base text-sm ">
            ...
            <p>
              Khởi hành:{" "}
              <span className="font-bold">{tour.departure_point}</span>
            </p>
          </div>
            ...
            <div className="flex items-center sm:text-base text-sm ">
              ...
              <p>
                ...
                <span className="font-bold">
                  {date && formatDate(date.start_date)}
                </span>
              </p>
            </div>
          )}
          ...
          {date && (
            <div className="flex items-center sm:text-base text-sm ">
              ...
              <p>
                Số chỗ còn:{" "}
                <span className="font-bold">{date?.remain_seats} chỗ</span>
              </p>
            </div>
          )}
        </div>
        ...
        <div className="flex space-x-4 mt-6">
          ...
          {date ? (
            ...
            <p className="italic text-md">Vui lòng chọn ngày khởi hành</p>
          )}
        </div>
      </div>
    </div>
