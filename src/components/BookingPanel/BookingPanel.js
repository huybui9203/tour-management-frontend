...
const BookingPanel = () => { 
    ...
    return ( 
        <div className="w-full mx-auto lg:max-w-none lg:w-1/3 lg:sticky right-0 lg:top-20 lg:self-start fixed z-30 lg:z-0 bottom-0 left-0 bg-white shadow-lg shadow-opacity-50 lg:shadow-none border-t-2 lg:border-t-0 border-red-400 ">
            <div className="lg:animate-slideInUp lg:shadow-xl hover:shadow-2xl lg:transition-shadow  p-6 rounded-lg shadow-md transition-shadow duration-300">
                <div className="mb-4">
